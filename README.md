...
4. Install will auto-create `/data/local/tmp/.il2cppdump/config.txt` template (it will not overwrite existing config), and set SELinux context for readability
